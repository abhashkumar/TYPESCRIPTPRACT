...
//This below line will through exception because myOtherAccount.name is unknown
//myOtherAccount.name;
...
type User_ = { name: string };
const myUserAccount = jsonParserUnknown(`{ "name": "Samuel" }`) as User_;
